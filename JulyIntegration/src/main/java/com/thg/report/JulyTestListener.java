...
public class JulyTestListener implements IReporter {
    ...
    private void outputResult(List<ITestResult> list) {
        try {
            ...
            template = template.replaceFirst("\\$\\{resultData\\}", Matcher.quoteReplacement(JSON.toJSONString(result)));
